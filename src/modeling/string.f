c subroutines for searching a keyword, making up a filename
c and others related with characters.
c
c filename(fname,str1,num,str2)
c		#output a string fname which is consisted of
c		#str1, num and str2
c get_num(x,nn,str,line,nl)
c		#output nn numbers to array x
c		#from a line containning the key word str and '='
c get_str(str_new,len_new,str,line,nl) 
c		#output a string str_new and its length len_new
c		#from a line containning the key word str and '='
c strlen(str,lenn)
c		#output the length of string str without any blank in the
c		#middle of it 
c num2str(string,num,len,len_new,itb,ch)
c		#output a string string which is converted from the number 
c		#num with a maximum length len 
c
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      subroutine itoa(number, str, str_len)
c
c     ITOA converts an interger 'number' to a string 'str'.
c     Written by Chaiwoot Boonyasiriwat (April 30, 2007)
c
      implicit none
...
!----------------------------------------------------------------------
      ...
      do i=1,nl
        ...
        if(ind.ne.0)then
          ...
          read(line_tmp(indeq+1:200),*,
     1      err=111,end=111)(x(k),k=1,nn)
          is_suc=1
          return
111       continue
          ind=0
